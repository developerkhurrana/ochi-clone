...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex">
      <div className="w-1/2 h-full font-[Impact] flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[7vw] uppercase leading-none">Eye-</h1>
          <h1 className="text-[7vw] uppercase leading-none">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 h-full font-[Impact] flex flex-col justify-between">
        <h1 className="text-[7vw] uppercase leading-none">Presentations</h1>
